...
//////////////////////////////////////////////////////////////////////
$usn=$_GET["usn"];
$_POST['username']=$_GET["usn"];
$_POST['path']="./user_files/".$_POST['username']."/raw_IDE";
$_POST['password']=$_GET["pass"];
$_POST['project_name']=$_GET["proj"];
...
//////////////////////////////////////////////////////////////////////
    ...
    $rel = str_replace('/components/install/process.php', '', '/components/install/process.php');
...
if (!file_exists($users) && !file_exists($projects) && !file_exists($active)) {
    ...
    $_POST['project_path']=$_POST['project_name'];
...
// PATH TO CODIAD
define("BASE_PATH", "/var/www/html/raw_IDE");

// BASE URL TO CODIAD (without trailing slash)
define("BASE_URL", ' . '$_SERVER["HTTP_HOST"]."/raw_IDE")' . ';
